== (Modern Savage Beast with) An Axe
...
This version of (Modern Savage Beast with) An Axe has been tested working in Rails 3.0.

== Installation

Add 'an_axe' to your Gemfile.

gem 'an_axe', '0.0.1'

Then bundle install to pull in the dependencies.
...
gem 'kaminari', '~> 0.12' # -will_paginate-
...
Copyright (c) 2011 Peter Boling. See LICENSE.txt for further details.
